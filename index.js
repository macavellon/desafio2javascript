...
console.log("a) Las pizzas con numero de id impar son: ")
...
const devpizza= pizzas.some(pizza=>pizza.precio<600)

console.log(devpizza ? "b) Hay alguna pizza de menos de $600" : "b) No hay ninguna pizza de menos de $600")

// const devpizza = pizzas.some((pizza) => {
...
console.log("************************************************************************************")
console.log("c) Cada pizza con su respectivo precio:")
pizzas.forEach((pizza) => {
